            ...
            <div class="card-body">
                <form method="POST" action="{{route('admin.register')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9"> <input type="email" name="email" class="form-control" id="email" value="{{old('email')}}"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="department_id">بخش</label>
                        <div class="col-sm-9">
