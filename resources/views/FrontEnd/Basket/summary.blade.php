@inject('cost' , 'App\Services\Cost\Contract\CostInterface')
	...
	<div class="card-body">
		...
		<div class="well">
			<table class='table'>
					...
					<tr>
					<td>{{$description}}</td>
					<td> {{\App\Helper\Format\Number::PersianNumberFormat($price)}} @lang('payment.toman')</td>
				</tr>
					@endforeach
				<tr>
					<td>@lang('payment.basket total')</td>
					<td> {{\App\Helper\Format\Number::PersianNumberFormat($cost->getTotalCosts())}} @lang('payment.toman')</td>
				</tr>
